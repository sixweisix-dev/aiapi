...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'goofish', name: 'GoofishIntegration', component: () => import('@/views/GoofishIntegration.vue') },
      ...
      { path: 'backup-restore', name: 'BackupRestore', component: () => import('@/views/BackupRestore.vue') },
